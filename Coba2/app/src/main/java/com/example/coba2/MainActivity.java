...
//        joystick = findViewById(R.id.joystick);
        ...
        final TextView teks = findViewById(R.id.text);
        final TextView teks2 = findViewById(R.id.Jarak);
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (distance > someThreshold) {
                        if (distance > baseRadius - knobRadius) {
                            ...
                            Log.d("Jarak", "jarak sebelum int :" +distance);
                        }
                    ...
                    Log.d("Jarak", "jarak sesudah int :" +jarak);

                    float kurva = (x - centerX);
                    float kurva2 = (y - centerY);
                    int nilaiy = (int) kurva2;
                    int nilaix = (int) kurva;
                    Log.d("kurva", "nilai x :" + nilaix);
                    Log.d("kurva", "nilai y :" + nilaiy);
                    teks.setText("Sudut : " + nilaix);
                    teks2.setText("Jarak : " + nilaiy);
...
//        });
        ...
        slider.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                value = progress - 1; //
                statusText.setText("Nilai: " + value);
                perbaruiData();
